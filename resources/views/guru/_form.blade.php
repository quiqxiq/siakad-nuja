<div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
    ...
    <x-form.input label="NIP" name="nip" type="number" min="1" inputmode="numeric" class="no-spinner" onkeydown="if(['e','E','+','-','.'].includes(event.key)) event.preventDefault()" :value="$guru->nip ?? ''" placeholder="contoh: 198501012010011001" required />
    ...
    <x-form.input label="No. HP" name="no_hp" type="tel" inputmode="numeric" pattern="[0-9+\s-]*" :value="$guru->no_hp ?? ''" placeholder="08..." />
</div>
